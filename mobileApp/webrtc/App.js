...
class App extends React.Component {
  ...
  componentDidMount = () => {
    this.socket = io.connect('https://93652c23b0b4.ngrok.io/webrtcPeer', {
      path: '/io/webrtc',
      query: {},
    });
  ...
  createOffer = () => {
    ...
    this.pc.createOffer({offerToReceiveVideo: 1}).then((sdp) => {
      console.log('sdp offer', JSON.stringify(sdp));
